...
namespace ITICommunity
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<TicketsDilenyContext>(m => m.UseSqlServer(Configuration.GetConnectionString("TicketsDilenyContext")));
        ...
        private static void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TicketsDilenyTech api", Version = "v1" });
